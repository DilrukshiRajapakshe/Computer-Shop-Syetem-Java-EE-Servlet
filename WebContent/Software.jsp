...
<div >
	<form  name="myForm" action= "SoftWareServlet" method="post" >
                ...
                <table id="table1" >
                    ...
                    <tr>
                        ...
                        <th><input id="text1" type="text" name="expiredDate" ></th>
                    </tr>
    ...
    <form id="search-form" name="search" action="SoftwareSearch.jsp" method="get">
