...
<div >
                <table id="table7" >
                    ...
                    <tr>
                        <td id="td1"><b>Product name </b></th>
                
                        <td id="td1"><b>Modular type</b></th>
                   
                        <td id="td1"><b>expired Date </b></th>
                      
                        <td id="td1"><b>Price </b></th>
                  
                        <td id="td1"><b>Available Amount</b></th>
                     </tr>
          <%   
          		ResultSet re = null;
      			PreparedStatement st = conn.prepareStatement("Select*  from software");
                re = st.executeQuery();
				while(re.next()){
		  ...
		  %> 
                     <tr>
						...
						<td id="td1"><%=re.getString("modularTYPE") %></td>
						<td id="td1"><%=re.getString("expiredDate") %></td>
						<td id="td1"><%=re.getString("price") %></td>
						<td id="td1"><%=re.getString("availableAmount") %></td>
